...
const GithubIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-slate-200 hover:text-white transition-colors">
...
const XIcon = () => (
  <svg viewBox="0 0 24 24" fill="white" className="w-5 h-5 hover:text-slate-300 transition-colors">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          <div className="relative w-72 h-72 md:w-[480px] md:h-[480px] flex items-center justify-center">
            ...
            <div className="absolute inset-4 border-2 border-dashed border-slate-700/40 rounded-full animate-[spin_30s_linear_infinite]" />
            <div className="absolute inset-12 border-2 border-slate-800/60 rounded-full animate-[spin_25s_linear_infinite_reverse]" />
            <div className="absolute inset-24 border-[3px] border-slate-900/80 rounded-full" />
            
            {/* Image Container */}
            <div className="relative w-56 h-56 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-white/5 shadow-2xl z-10 bg-slate-900">
              <Image
